...
def check_pipeline_params():
    ...
    if os.access(backup_file, os.R_OK):
        if not filecmp.cmp(backup_file,configfile):
            ...
            import_data_kwds = ['project_name','data_path','jvla','mstransform','keep_','hanning']
            flag_calib_split_kwds = ['src_dir','shadow_tol','quack_int','timecutoff','freqcutoff','rthresh','refant','no_rflag',
