...
def check_pipeline_params():
    ...
    if os.access(backup_file, os.R_OK):
        if not filecmp.cmp(backup_file,configfile):
            ...
            import_data_kwds = ['project_name','data_path','jvla','gmrt','mstransform','keep_','hanning', 'chanavg']
            ...
            contsub_dirty_image_kwds = ['linefree_ch','fitorder','save_cont','line_ch','uvtaper']
